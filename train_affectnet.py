...
def parse_args():
    ...
    parser.add_argument('--aff_path', type=str, default='./data/fer_112_112_v2.0/affectnet/',
...
def run_training():
    ...
    model = MHAN(num_class=args.num_class, num_head=args.num_head)
    model.to(device)
    ...
    train_dataset = datasets.ImageFolder(f'{args.aff_path}/training', transform=data_transforms)
    ...
    print('Whole training set size:', train_dataset.__len__())
